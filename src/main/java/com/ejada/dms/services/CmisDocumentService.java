...
public class CmisDocumentService {
    private final static String DOCUMENT_CLASS_SYMBOLIC_NAME = "Document";
    //root folder path of dms
    private final static String folderPath = "/SmartContract";
    ...
    public static String createDocumentFromPath(String path, Map<String, String> properties) {
    ...
    public static Document retrieveDocumentById(String docId, String downloadPath) {
    ...
    public static String updateDocumentById(String path, String docId, Map<String, String> properties) {
    ...
    public static List<String> retrieveDocumentsByQuery(String documentClassSymbolicName, String where) {
